          ...
          <div class="box-header with-border"></div>
            ...
            <div class="box-body">
              ...
              <div class="box">
                  ...
                  <div class="col-xs-4 pull-right" id="clasetipocambio" >
                    
                    <table class="table" aling = "right">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-12">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control input-lg" id="observacionVenta" name="observacionVenta" placeholder="Ingrese Observacion"  required>
                      </div>
                    </div>
