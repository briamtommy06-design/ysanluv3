...
<head>
  ...
  <link rel="icon" type="image/png" href="vistas/img/plantilla/tecnologia.png">

  <title>Ysanlu System</title>
...
<!--   <link rel="icon" href="vistas/img/plantilla/icono-negro.png"> -->
    ...
    <!-- PLUGINS DE CSS -->
      ...
      <!-- Google Font 
      <link rel="stylesheet" href="vistas/dist/css/font.css">-->
  ...
  <?php
    ...
    if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"]=="ok"){
      ...
      if(isset($_GET["ruta"])){
        ...
        $_GET["ruta"]== "reportes"||
        $_GET["ruta"]== "marcas" ||
        $_GET["ruta"]== "generar-boleta"||
        $_GET["ruta"]== "configuracion"||
        $_GET["ruta"]== "ver-boletas"||
